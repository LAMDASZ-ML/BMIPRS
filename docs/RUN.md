...
bash scripts/maple/base2new_train_maple.sh imagenet 1 cuda:0
...
python parse_test_res.py output/base2new-OLD/train_base/imagenet/shots_16/MaPLeold/vit_b16_c2_ep5_batch4_2ctx
# averaged results for novel classes
python parse_test_res.py output/base2new-OLD/test_new/imagenet/shots_16/MaPLeold/vit_b16_c2_ep5_batch4_2ctx --test-log
```
...
for SEED in 1 2 3
do
    bash scripts/maple/xd_test_bitp.sh caltech101 ${SEED}
    bash scripts/maple/xd_test_bitp.sh oxford_pets ${SEED}
    bash scripts/maple/xd_test_bitp.sh stanford_cars ${SEED}
done
```
...
for SEED in 1 2 3
do
    bash scripts/maple/xd_test_bitp.sh imagenetv2 ${SEED}
    bash scripts/maple/xd_test_bitp.sh imagenet_sketch ${SEED}
    bash scripts/maple/xd_test_bitp.sh imagenet_a ${SEED}
    bash scripts/maple/xd_test_bitp.sh imagenet_r ${SEED}
done
```
...
python parse_test_res.py output/evaluation/MaPLeold/vit_b16_c2_ep5_batch4_2ctx_cross_datasets_16shots/food101 --test-log
```
