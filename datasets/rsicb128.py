...
class RSICB128(DatasetBase):
    dataset_dir = "RSICB128"  # 数据集在文件系统中的根目录名称
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_chen_RSICB128.json")  # 数据分割文件路径
        ...
        if os.path.exists(self.split_path):
            ...
            print(f"Generating new data split for RSICB128 and saving to {self.split_path}")
